...
print, 'dxu+i = ', dxu + i
    ...
    indx4=where((data_mat(1,*) eq float(dxu+i)) and (data_mat(2,*) ge zzero))
    ;print, data_mat(*, indx4)
...
;; We only need the sum of all the branches with a common upper level.
