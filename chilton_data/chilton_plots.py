...
def excfunc():
    ...
    label = '1p0' r'$\rightarrow$'  '2p10 ' '($\Delta J=1)$'
    pl.plot(ourdat10[:,0], ourdat10[:,2], 'r', label=label)
    pl.plot(ourdat10[:,0], ourdat10[:,3], 'g-.')
    pl.plot(chil_dir10[:,0], chil_dir10[:,1] / 10. *0.7, 'rD')
    pl.plot(chil_dir10[:,2], chil_dir10[:,3] / 10. * 0.7, 'go')
    ...
    label = '1p0' r'$\rightarrow$'  '2p9 ' '($\Delta J=3)$'
    pl.plot(ourdat9[:,0], ourdat9[:,2], 'r', ms=7, label=label)
    pl.plot(ourdat9[:,0], ourdat9[:,3], 'g-.')
    pl.plot(chil_dir9[:,0], chil_dir9[:,1] / 10., 'ro')
    ...
    label = '1p0' r'$\rightarrow$'  '2p8 ' '($\Delta J=2)$'
    pl.plot(ourdat8[:,0], ourdat8[:,2], 'r', label=label)
    pl.plot(ourdat8[:,0], ourdat8[:,3], 'g-.')
    pl.plot(chil_dir8[:,0], chil_dir8[:,1] / 10. * 0.7, 'ro')
    ...
    label = '1p0' r'$\rightarrow$'  '2p7 ' '($\Delta J=1)$'
    pl.plot(ourdat7[:,0], ourdat7[:,2], 'r', label=label)
    pl.plot(ourdat7[:,0], ourdat7[:,3], 'g-.')
    pl.plot(chil_dir7[:,0], chil_dir7[:,1] / 10. * 0.6, 'ro')
    ...
    label = '1p0' r'$\rightarrow$'  '2p6 ' '($\Delta J=2)$'
    pl.plot(ourdat6[:,0], ourdat6[:,2], 'r', label=label)
    pl.plot(ourdat6[:,0], ourdat6[:,3], 'g-.')
    pl.plot(chil_dir6[:,0], chil_dir6[:,1] / 10. * 0.7, 'ro')
    ...
    label = '1p0' r'$\rightarrow$'  '2p5 ' '($\Delta J=0)$'
    pl.plot(ourdat5[:,0], ourdat5[:,2], 'r', label=label)
    pl.plot(ourdat5[:,0], ourdat5[:,3], 'g-.')
    pl.plot(chil_dir5[:,0], chil_dir5[:,1] / 10. * 0.7, 'ro')
    ...
    label = '1p0' r'$\rightarrow$'  '2p4 ' '($\Delta J=1)$'
    pl.plot(ourdat4[:,0], ourdat4[:,2], 'r', label=label)
    pl.plot(ourdat4[:,0], ourdat4[:,3], 'g-.')
    pl.plot(chil_dir4[:,0], chil_dir4[:,1] / 10. * 0.7, 'ro')
    ...
    pl.plot(ourdat3[:,0], ourdat3[:,2], 'r', label=label)
    pl.plot(ourdat3[:,0], ourdat3[:,3], 'g-.')
    pl.plot(chil_dir3[:,0], chil_dir3[:,1] / 10. *0.7, 'ro')
    ...
    label = '1p0' r'$\rightarrow$'  '2p2 ' '($\Delta J=1)$'
    pl.plot(ourdat2[:,0], ourdat2[:,2], 'r', label=label)
    pl.plot(ourdat2[:,0], ourdat2[:,3], 'g-.')
    pl.plot(chil_dir2[:,0], chil_dir2[:,1] / 10. *0.5, 'ro')
    ...
    label = '1p0' r'$\rightarrow$'  '2p1 ' '($\Delta J=0)$'
    pl.plot(ourdat1[:,0], ourdat1[:,2], 'r', label=label)
    pl.plot(ourdat1[:,0], ourdat1[:,3], 'g-.')
    pl.plot(chil_dir1[:,0], chil_dir1[:,1] / 10. *0.7, 'ro')
