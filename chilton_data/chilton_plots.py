...
pl.plot(20.0, 5.4, 'bs', ms=3)
errorbar = pl.errorbar(20, 5.4, yerr=1.5, ls="None", color = 'b')
pl.plot(40.0, 2.6, 'bs', ms=3)
...
pl.plot([20.0,30.0,40.0], [5.3,4.5,3.7], 'r^', ms=5)
pl.plot(20.0, 5.0, 'bs', ms=3)
